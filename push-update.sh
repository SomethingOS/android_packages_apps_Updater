...
updates_dir=/data/somethingos_updates
...
adb shell "killall com.somethingos.updater 2>/dev/null"
adb shell "sqlite3 /data/data/com.somethingos.updater/databases/updates.db" \
