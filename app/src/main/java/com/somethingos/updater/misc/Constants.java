...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.somethingos.version";
    public static final String PROP_DEVICE = "ro.somethingos.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "somethingos.updater.allow_downgrading";
